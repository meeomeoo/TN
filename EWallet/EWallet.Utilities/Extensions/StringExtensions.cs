...
namespace EWallet.Utilities.Extensions
{
    ...
    public static class StringExtensions
    {
        ...
        public static string OpenSSLEncrypt(string plainText, string passphrase)
        {
            ...
            {
                //CommonLogger.DefaultLogger.Error("OpenSSLEncrypt:error:" + e);
                //CommonLogger.DefaultLogger.Error("OpenSSLEncrypt:text error:" + plainText);
            }
        ...
        /// <para>Description: Định dạng số</para>
        /// </summary>
        /// <returns></returns>
        public static string FormatMoney(this decimal num)
        {
